#ifndef __IPC_10800P_DEMO_H__
#define __IPC_10800P_DEMO_H__

/*****************************************************************************
 * 1080P摄像头(帧率主要看摄像头配置表,SDK默认2053 15帧)
 * 主码流(H264):1920x1080 @ 15fps
 * 辅码流(H264):1280x720  @ 15fps
 ...
 * 不同镜头以及功能不一样
 * 没有考虑大分辨拍照模式
 * 1080P镜头:  90K(VPP_DATA0)(1080P h264) ≈ 90K
				其他:  12K(gen420)+10K(解码) + ISP + 其他(某些结构体用到) ≈ 50K(动态使用,gen420和解码可以分时复用)
...
#define WIFI_PS_NO_FRM_LOSS_EN          1           //缓存的TX休眠帧是否不允许丢弃
...
/*************************************************************
 * 1080P摄像头的h264副码流需要打开VPP_BUF1_EN
 * 1080P的辅码流是h264,注意SUB_STREAM_WIDTH需要是与镜头

...
#undef  R_USBD_VIDEO
#define R_USBD_VIDEO        R_USBD_VIDEO_MJPEG
...
#define VIDEO_VS_INPUT_HEADER_wTotalLength   (VIDEO_VS_INPUT_HEADER_DESC_LEN + VIDEO_MJPEG_HEADER_LEN)
...
static rt_bool_t usbd_uvc_init(struct ufunction *func)
{
    ...
    usbd_uvc_thread = rt_thread_create("usbd_uvc_thread_mjpeg",
                                        usbd_uvc_entry, func,
                                        1024,

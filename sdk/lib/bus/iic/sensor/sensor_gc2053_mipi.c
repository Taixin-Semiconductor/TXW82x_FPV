...
//IPC 使用,行间隔很大，最高20帧
SENSOR_INIT_SECTION const unsigned char gc2053_1920x1080_15fps_1lane[CMOS_INIT_LEN] =
{
	//mclk 24Mhz
	//window size 1928*1088
	//mipiclk 696Mbps/lane
...
//IPC 使用,行间隔较大，最高20帧
SENSOR_INIT_SECTION const unsigned char gc2053_1920x1080_15fps_2lane[CMOS_INIT_LEN] =
{
	/**** system ****/
	0xfe, 0x80,
	0xfe, 0x80,
...
/**** CISCTL & ANALOG ****/
	...
	0x90, 0x00, //vts控制帧率
	0x41, 0x05,
	0x42, 0x78, //vts=1350-25fps//1125-30fps
	0x9d, 0x10, //min vb=16
...
static const SensorWorkMode gc2053_supported_modes[] = {
    ...
    // 单目
    {
        .mode = CAM_MODE_SINGLE_MAIN_ONLY,
	...
	// 1 lane 单目IPC + 辅码流, 加大行间隔，降低编码压力
    {
        ...
        .reg_list = gc2053_1920x1080_15fps_1lane,
    },
	// 2ane 单目IPC + 辅码流, 加大行间隔, 降低编码压力
    {
        .mode = CAM_SINGLE_MASTER_MODE,
		.bayer_patten = ISP_BAYER_FORMAT_RGGB,
        .width = 1920,
        ...
        .reg_list = gc2053_1920x1080_15fps_2lane,
    },

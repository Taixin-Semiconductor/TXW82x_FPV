...
SENSOR_INIT_SECTION const unsigned char f37pInitTable[CMOS_INIT_LEN]= 
{	
    0x12, 0x40,
    0x48, 0x8A,
    0x48, 0x0A,
...
const _Sensor_CCM f37p_ccm_init =
{
    // 5500k, gamma2p2
    0x39e,  0xeb5,  0xfe9,
    0xe20,  0x28e,  0xe20,
...
const _Sensor_BLC f37p_blc_init =
{
    0*16, 0*16, 0*16, 0*16,
}; 

const _Sensor_AWB f37p_awb_init = 
{
//    r,  gr,  gb,   b
    356, 256, 256, 370, // default
    302, 256, 256, 370, // min
    356, 256, 256, 470, // max
};

const _Sensor_AE f37p_ae_init = 
{
...
const _Sensor_CSUPP f37p_csupp_init = {
...
const _Sensor_SHARP f37p_sharp_init = {
...
const _Sensor_YUVNR f37p_yuvnr_init = {
    20,20,20,20,20,20,20,20,
    205,255,0,
};

const _Sensor_COLENH f37p_colenh_init = {
    50,
    60,
    50,
    0,
...
const _Sensor_BV2NR f37p_bv2nr_init[BV2RAWNR_ARRAY_NUM] = {
...
const _Sensor_LSC       f37p_lsc_init = {
...
SENSOR_OP_SECTION const _Sensor_Adpt_ f37p_cmd= 
{	
	.typ = 1, //YUV
	.pixelw = 1920,
	.pixelh = 1080,
	...
	.init = (uint8 *)f37pInitTable,
    .init_len = sizeof(f37pInitTable),
    .mipi_lane_num = 2,
	.rotate_adapt = {0},
...
const _Sensor_Ident_ f37p_init=
{
	0x41,0x80,0x81,0x01,0x01,0x0b
};

const _Sensor_ISP_Init f37p_isp_init = 
{
    ...
    .adjust_func  = (isp_ae_func     )f37p_ae_adjust,
    .p_adpt       = (_Sensor_Adpt_  *)&f37p_cmd,
    .p_ident      = (_Sensor_Ident_ *)&f37p_init,
    .p_blc        = (_Sensor_BLC    *)&f37p_blc_init,
    .p_ccm        = (_Sensor_CCM    *)&f37p_ccm_init,
    .p_awb        = (_Sensor_AWB    *)&f37p_awb_init,
    .p_ae         = (_Sensor_AE     *)&f37p_ae_init,
    .p_csupp      = (_Sensor_CSUPP  *)&f37p_csupp_init,
    .p_sharp      = (_Sensor_SHARP  *)&f37p_sharp_init,
    .p_yuvnr      = (_Sensor_YUVNR  *)&f37p_yuvnr_init,    
    .p_colenh     = (_Sensor_COLENH *)&f37p_colenh_init,
    .p_bv2nr      = (_Sensor_BV2NR  *)f37p_bv2nr_init,
    .p_lsc        = (_Sensor_LSC    *)&f37p_lsc_init,
};

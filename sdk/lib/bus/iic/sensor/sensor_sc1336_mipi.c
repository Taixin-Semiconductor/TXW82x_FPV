...
SENSOR_INIT_SECTION const unsigned char sc1336InitTable[CMOS_INIT_LEN]= 
{
    0x01, 0x03, 0x01,
    0x01, 0x00, 0x00,
    0x36, 0xe9, 0x80,
...
const _Sensor_CCM sc1336_ccm_init =
{
    // 5500k, gamma2p2
    0x18b,  0xf95,  0xff2,
    0xf79,  0x183,  0xf61,
...
const _Sensor_BLC sc1336_blc_init =
{
    260, 260, 260, 260,
}; 

const _Sensor_AWB sc1336_awb_init = 
{
//    r,  gr,  gb,   b
...
const _Sensor_AE sc1336_ae_init = 
{
    .max_frame_length      = 750,
    .min_frame_vb          = 5,
    .max_analog_gain       = 32<<8,
    .min_analog_gain       =  1<<8,
    .default_exposure_line = 745,
    .max_exposure_line     = 745,
...
const _Sensor_CSUPP sc1336_csupp_init = {
...
const _Sensor_SHARP sc1336_sharp_init = {
#if 0
...
const _Sensor_YUVNR sc1336_yuvnr_init = {
    20,20,20,20,20,20,20,20,
    205,255,0,
};


const _Sensor_COLENH sc1336_colenh_init = {
	1,
    50,
    60,
    50,
...
const _Sensor_BV2NR sc1336_bv2nr_init[BV2RAWNR_ARRAY_NUM] = {
...
const _Sensor_LSC          sc1336_lsc_init = {
    .p_lsc_tbl = (uint32 *)sc1336_lsc_tbl,
};
...
const _Sensor_ISP_Init sc1336_isp_init = 
{
    ...
    .p_blc        = (_Sensor_BLC    *)&sc1336_blc_init,
    .p_ccm        = (_Sensor_CCM    *)&sc1336_ccm_init,
    .p_awb        = (_Sensor_AWB    *)&sc1336_awb_init,
    .p_ae         = (_Sensor_AE     *)&sc1336_ae_init,
    .p_csupp      = (_Sensor_CSUPP  *)&sc1336_csupp_init,
    .p_sharp      = (_Sensor_SHARP  *)&sc1336_sharp_init,
    .p_yuvnr      = (_Sensor_YUVNR  *)&sc1336_yuvnr_init,    
    .p_colenh     = (_Sensor_COLENH *)&sc1336_colenh_init,	
    .p_bv2nr      = (_Sensor_BV2NR  *)sc1336_bv2nr_init,	
    .p_lsc        = (_Sensor_LSC    *)&sc1336_lsc_init,
};
...
const _Sensor_Ident_ sc1336_init=
{

...
const _Sensor_COLENH_BV gc2083_ce_map[BV2COLENH_ARRAY_NUM] = {
    {.bv =   29491, .hue = 0, .luma = 50, .contrast = 56, .saturation = 100},
    {.bv =    6000, .hue = 0, .luma = 50, .contrast = 56, .saturation = 100},
    {.bv =    5000, .hue = 0, .luma = 50, .contrast = 56, .saturation = 100},
    {.bv =     650, .hue = 0, .luma = 50, .contrast = 56, .saturation = 50},

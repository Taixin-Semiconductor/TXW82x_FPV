...
const _Sensor_AWB gc1084_awb_init = 
{
    ...
    .constraint = {
		...
		.sec_line_slope      = {       0.125,  0.71428571,   1.5789474,   1.6206897,   1.5909091,           0,           0,           0},
		.sec_line_offset     = {     135.875,   47.142857,  -99.631579,  -131.96552,  -205.09091,           0,           0,           0},
		.sec_line_sqrtk2add1 = {  0.99227788,  0.81373347,  0.53505208,  0.52510733,  0.53217155,           0,           0,           0},
		.center_line_slope   = {          -8, -0.66666667, -0.58333333, -0.62857143,           0,           0,           0},
		.center_line_offset  = {        1119,         217,      205.25,   212.17143,           0,           0,           0},
		.lower_line_slope    = {  -4.8861138,  -1.0344963, -0.19354257, -0.62858901,           0,           0,           0},
		.lower_line_offset   = {   667.63351,    240.8974,   131.32201,   194.45743,           0,           0,           0},
		.upper_line_slope    = {  -1.9895704, -0.58222977,   -0.582807, -0.81057448,           0,           0,           0},
		.upper_line_offset   = {   412.72044,   222.43953,   222.52555,   259.16802,           0,           0,           0},
		.corner_limit        = {   106.11583,    149.13948,    130.92278,    152.24035,    180.01743,    81.300452,    193.32172,    102.46637},
    },
};
...
const _Sensor_AE gc1084_ae_init = 
{
    ...
    .min_analog_gain       =  1<<8,
    .default_exposure_line = 883,
    .max_exposure_line     = 883,
    .min_exposure_line     = 1,
    .row_time_us           = 47,
...
const _Sensor_LHS gc1084_lhs_map[] = {
    ...
    {           160,           203,          247,              +0,                       32},  // green enhance(plants),    range:
